...
architecture implementation of PROC_AXI_Master is
...
begin
	...
	M_AXI_AWADDR	<= std_logic_vector( unsigned(C_M_TARGET_SLAVE_BASE_ADDR) + unsigned(addr) );
	...
	--Read Address (AR)
	M_AXI_ARID	<= (others => '0');
	M_AXI_ARADDR	<= std_logic_vector( unsigned( C_M_TARGET_SLAVE_BASE_ADDR ) + unsigned( addr ) );
	--Burst LENgth is number of transaction beats, minus 1
